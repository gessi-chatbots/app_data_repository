...
@RestController
public class DigitalDocumentsController<T> implements GraphDBApi<Object> {
    private final Logger logger = LoggerFactory.getLogger(DigitalDocumentsController.class);
    ...
    @Autowired
    public DigitalDocumentsController(final GraphDBService graphDBService,
